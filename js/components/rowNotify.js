...
export default class RowNotify extends Component {
    constructor(props){
        super(props)
    ...
    render(){
        let row=null;
        let {content,assignTime,subjectId,classId} =this.props.item;
        ...
        ><View style={styles.homework_container}>
            ...
            <View style={styles.homework_container_mid}>
                <Text style={styles.homework_midText1}>{content}</Text>
